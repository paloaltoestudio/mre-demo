  ...
  return (
    <div className="max-w-[1200px] mx-auto flex items-center flex-col justify-center">
      ...
      <div className="w-full flex flex-col items-end justify-end mt-10 pr-10">
        <button onClick={() => navigate('/auth/verified')} className="bg-[#3466cc] text-white font-medium py-2 px-4 rounded-full hover:cursor-pointer hover:bg-[#3467cce8]">Continuar</button>
      </div>
    </div>
  );
};
