...
export const RegistryForm: React.FC = () => {
  ...
  const { setFromAuth, setTypeUser, setRegistry } = useRoutesStore();
  ...
  const handleChange = (
    ...
    if (e.target.value === "Cédula de Extranjería") setTypeUser("Extranjero");
    else setTypeUser("Ciudadano");
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!termsValid) {
      alert(
        "Debes aceptar los términos y condiciones y el tratamiento de datos"
      );
      return;
    }
    ...
    if (!contactValid) {
      alert(
        "Por favor completa al menos un método de contacto válido (email, teléfono o WhatsApp)"
      );
      return;
    }
    ...
    if (!passwordValid) {
      ...
      alert(
        `Por favor corrige los siguientes requisitos de contraseña:\n\n${missingRequirements.join(
          "\n"
        )}`
      );
      return;
      ...
      <div className="p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div
            ...
            style={{ marginTop: 40 }}
          >
            Para completar tu registro debes diligenciar al menos uno de los
            siguientes campos.
          ...
          {/* Línea divisoria */}
          <div
            className="flex items-center select-none text-gray-400"
            style={{ marginTop: 4 }}
          >
          ...
          <div className="mt-6">
            <p className="font-semibold mb-2 text-gray-700 text-center text-md">
              Crear contraseña
            </p>
            <input
              type="password"
